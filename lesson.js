...
const firebaseConfig = { // กำหนดค่าคอนฟิกูเรชันสำหรับ Firebase
...
firebase.initializeApp(firebaseConfig); // เริ่มต้น Firebase ด้วยค่าคอนฟิกูเรชัน
...
// เรียกใช้ preloadAllGameAudio โดยตรงเมื่อสคริปต์โหลด (ไม่ต้องตรวจสอบล็อกอิน)
